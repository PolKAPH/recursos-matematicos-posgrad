...
Este repositório é um **espaço de compartilhamento colaborativo** criado para:

✅ **Facilitar o estudo** de colegas mestrandos  
✅ **Preparação para exames** de qualificação  
✅ **Colaboração e melhoramento contínuo** entre estudantes  

---

## 💬 Feedback e Contribuições

**Encontrou um erro ou tem sugestões?** Adoramos sua contribuição!

### Maneiras de contribuir:

1. **Reportar erros por email:**
   - `kelvinadan@ufpr.br`
   - `183077@unsaac.edu.pe`

2. **Submeter melhorias via Pull Request:**
   - Faça um [Fork](https://github.com/PolKAPH/analisis-solucoes/fork)
...
Este trabalho está sob licença **Creative Commons Atribução-NãoComercial-CompartilhaIgual 4.0** (CC BY-NC-SA 4.0)
...
- 📌 **Atribuir** o crédito original
- 🚫 **Não usar comercialmente**
- 🔄 **Compartilhar derivados** sob a mesma licença

🔗 [Leia a licença completa](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.pt_BR)
...
- ✏️ Soluções próprias a exercícios de livros publicados
- 📖 Exercícios clássicos da literatura matemática
